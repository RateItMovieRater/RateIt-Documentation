...
Cada filme tem também a sua respectiva equipe, formada por indivíduos que estão cadastradas no banco de dados na tabela "crew_member", e são nada mais nada menos que as pessoas que trabalharam na produção do filme, seja como atores, diretores, produtores ou cinegrafistas.

Os "crew_member", não são usuários do sistema, apenas figuras cadastradas no banco de dados para serem relacionadas à diversos filmes e então listadas.
...
| RN 04  | RF 05 | Apenas o administrador do sistema pode gerenciar os "crew_member".                                                                                                        |
